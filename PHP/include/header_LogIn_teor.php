<header>
      ...
      <div class="dropdown-content">
          <a href="./teor1.php">Общие сведения...</a>
          <a href="./teor2.php">Инструменты, присп... </a>
          <a href="./teor3.php">Подготовка плит...</a>
          <a href="./teor4.php">Приготовление рас...</a>
          <a href="./teor5.php">Подготовка вер...</a>
          <a href="./teor6.php">Отделка и уход...</a>
          <a href="./teor7.php">Технология рем...</a>
          <a href="./teor8.php">Выполнение обли...</a>
          <a href="./teor9.php">Охрана труда...</a>
      </div>
      </div>
      <div class="dropdown">
